...
SAMPLES = [
    ...
    AudioChunk(
        ...
        seq=0,
        file_path="p/chunk_000000.wav",
        duration_s=10.0,
        size_bytes=320044,
    ),
    SessionEvent(session_id="s", type=EventType.DEVICE_LOST, detail={"kind": "mic", "last_seq": 3}),
    ...
    ErrorResponse(
        error=ErrorBody(code=ErrorCode.DEVICE_MISSING, message="m", detail={"missing": ["mic"]})
    ),
